...
//        //评论回复
        if (list[position].portion?.size?:0 > 0) {
            ...
            if (list[position].portion?.size?:0 >= 2) {
                holder.itemView.tvOneTip.visibility = View.VISIBLE
    ...
    override fun setLayout(parent: ViewGroup, viewType: Int): View =
            LayoutInflater.from(parent.context).inflate(R.layout.item_shoumei_detail, parent, false)
