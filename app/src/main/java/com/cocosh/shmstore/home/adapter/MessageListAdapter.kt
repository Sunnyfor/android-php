 ...
 */
class MessageListAdapter(var context: Context, fm: FragmentManager, list: List<Fragment>, var mName: List<String>) : FragmentPagerAdapter(fm) {
    ...
    fun getTabView(position: Int): View {
        ...
        tabTitle.setTextColor(context.resources.getColor(R.color.grayText))
