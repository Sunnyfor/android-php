...
import com.cocosh.shmstore.baiduFace.model.DynamicParams;
import com.cocosh.shmstore.baiduFace.model.LivenessVsIdcardResult;
import com.cocosh.shmstore.baiduFace.utils.HttpUtil;
import com.cocosh.shmstore.baiduFace.utils.OnlineLivenessResultParser;
import com.cocosh.shmstore.baiduFace.utils.PoliceCheckResultParser;
...
public class APIService {
    ...
    public void policeVerify(String name, String idnumber, String file, OnResultListener
            listener) {
        DynamicParams params = new DynamicParams();
