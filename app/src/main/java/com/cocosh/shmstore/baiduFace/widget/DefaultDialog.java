 ...
 */
package com.cocosh.shmstore.baiduFace.widget;
...
public class DefaultDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public Builder setNegativeButton(int negativeButtonText, OnClickListener listener) {
            this.negative = (String) context.getText(negativeButtonText);
        ...
        public DefaultDialog create() {
            ...
            if (negative != null) {
                ...
                layout.findViewById(R.id.dialog_button).setVisibility(View.GONE);
            }
            if (message != null) {
