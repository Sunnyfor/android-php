...
platform_enterprise_num (integer, optional): 平台分配的企业主数量 ,
expand_matchmaker_num (integer, optional): 拓展的新媒人数量 ,
...
data class OperatorMainData(var time: String?,
                            ...
                            var platform_enterprise_num: String?,
                            var expand_matchmaker_num: String?,
