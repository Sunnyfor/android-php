...
//        val timeStampFormatDateYYMMdd = SimpleDateFormat("yyyy-MM-dd", Locale.getDefault())
//        var urlStr = ""
//        try {
//            urlStr = URLEncoder.encode(timeStampFormatDateYYMMdd.format(System.currentTimeMillis()), "Utf-8")
