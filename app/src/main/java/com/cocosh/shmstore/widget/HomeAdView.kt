...
import kotlinx.android.synthetic.main.layout_home_new_ad.view.*
 ...
 */
class HomeAdView : RelativeLayout {
    ...
    private var pointLayoutParams:LinearLayout.LayoutParams

    init {
        LayoutInflater.from(context).inflate(R.layout.layout_home_new_ad, this, true)
        pointLayoutParams = LinearLayout.LayoutParams(resources.getDimension(R.dimen.w24).toInt(), resources.getDimension(R.dimen.w24).toInt())
