...
public interface IPhotoView {
     ...
     * this IView and includes all scaling and translations.
     *
     ...
     * relative to this IView and includes all scaling and translations.
     *
    ...
    /**
     * Return the current scale tag in use by the ImageView.
     *
    ...
    /**
     * Register a callback to be invoked when the Matrix has changed for this IView. An example would
    ...
    /**
     * Register a callback to be invoked when the Photo displayed by this IView is tapped with a
     * single tap.
     *
     * @param listener - Listener to be registered.
     */
    ...
    /**
     * Register a callback to be invoked when the IView is tapped with a single tap.
     *
    ...
    /**
     * Returns a callback listener to be invoked when the IView is tapped with a single tap.
     *
