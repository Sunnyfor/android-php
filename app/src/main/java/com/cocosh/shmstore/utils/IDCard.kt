 ...
 * Created by zhangye on 2018/4/20.
 */
class IDCard {
    /**
     * 功能：身份证的有效验证
     ...
     */
    fun dDCardValidate(IDStr: String): String {
        var errorInfo: String// 记录错误信息
        val valCodeArr = arrayOf("1", "0", "x", "X", "9", "8", "7", "6", "5", "4", "3", "2")
...
//        // ================ 判断最后一位的值 ================
//        val totalmulAiWi = (0..16).sumBy { Integer.parseInt(ai[it].toString()) * Integer.parseInt(wi[it]) }
